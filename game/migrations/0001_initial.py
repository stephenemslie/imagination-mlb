# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-04 19:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', phonenumber_field.modelfields.PhoneNumberField(max_length=128, unique=True)),
        ...
        migrations.AddField(
            model_name='user',
            name='active_game',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='game.Game'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
